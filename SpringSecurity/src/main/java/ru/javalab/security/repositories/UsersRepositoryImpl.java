...
public class UsersRepositoryImpl implements UsersRepository {
    ...
    //language=SQL
    private static final String SQL_FIND_BY_CONFIRM_LINK = "select * from \"user\" where confirm_link = ?";
    //language=SQL
    ...
    public Optional<User> find(String username) {
        try {
            User user = jdbcTemplate.queryForObject(SQL_FIND_BY_EMAIL, new Object[]{username}, userRowMapper);
